            ...
            <div className="flex h-[400px]">
                ...
                <div className="w-2/3 p-8 bg-white">
                    <h4 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-6">
                        SERVICES FOR {activeData.subtitle.split(' ')[activeData.subtitle.split(' ').length - 1]?.toUpperCase() || 'GROWTH'}
                    </h4>
                    ...
                    <div className="grid grid-cols-2 gap-8">
                        {activeData.solutions.map((solution, idx) => (
                            <a key={idx} href={solution.href} className="flex gap-4 group">
                                ...
                                <div>
                                    <h5 className="font-semibold text-slate-900 text-lg group-hover:text-brand transition-colors">
                                        {solution.title}
                                    </h5>
