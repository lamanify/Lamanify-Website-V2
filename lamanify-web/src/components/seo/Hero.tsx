        ...
        <section className="relative pt-32 pb-20 overflow-hidden bg-slate-50">
            ...
            <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-200/50 border border-slate-200 backdrop-blur-sm mb-8">
                    ...
                    <span className="text-xs font-semibold uppercase tracking-wider bg-gradient-to-r from-brand to-brand-dark bg-clip-text text-transparent">Google SEO Service</span>
                </div>
                ...
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tight text-slate-900 mb-6 max-w-5xl mx-auto leading-[1.1]">
                    <span className="bg-gradient-to-r from-brand to-brand-dark bg-clip-text text-transparent">Healthcare Search Engine Optimization (SEO)</span> Service for Clinics.
                </h1>

                <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-3xl mx-auto">
                    Powered by AI SEO. SEO That Fills Your Clinic With High Quality Patients Organically.
                </p>

                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
                    <Button variant="primary" className="h-12 px-8 text-lg rounded-full shadow-xl shadow-brand/20 hover:shadow-brand/40 transition-all" onClick={() => window.location.href = '#book'}>
                        Request a Strategy Consultation <ArrowRight className="ml-2 h-5 w-5" />
                    </Button>
                </div>
                ...
                <div className="relative max-w-5xl mx-auto">
                    <div className="bg-white rounded-2xl shadow-2xl border border-slate-100 p-2 md:p-4 rotate-x-12 transform-gpu perspective-1000">
                        ...
                        <div className="flex items-center justify-between border-b border-slate-100 pb-4 mb-6 px-4">
                            ...
                            <div className="text-xs font-medium text-slate-400 uppercase tracking-widest">Live Organic Growth</div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 p-4">
                            ...
                            {/* Stat 2 */}
                            <div className="flex flex-col items-center justify-center space-y-2">
                                <div className="text-sm text-slate-500">New Patient Inquiries</div>
                                <div className="text-3xl font-bold text-slate-900">145</div>
                                <div className="flex items-center text-emerald-500 text-sm font-medium">
                                    <TrendingUp className="h-4 w-4 mr-1" /> +28%
                                </div>
                            </div>
                            {/* Stat 3 */}
                            <div className="flex flex-col items-center justify-center space-y-2">
                                <div className="text-sm text-slate-500">Keyword Rankings</div>
                                <div className="text-3xl font-bold text-slate-900">#1 - #3</div>
                                <div className="flex items-center text-emerald-500 text-sm font-medium">
                                    <TrendingUp className="h-4 w-4 mr-1" /> Top 3
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mt-8 flex items-end justify-between h-48 sm:h-64 gap-2 sm:gap-4 px-4 pb-4 border-b border-slate-100/50">
                            {[30, 45, 40, 60, 55, 75, 70, 85, 80, 90, 95, 100].map((height, i) => (
