        ...
        <section className="relative pt-32 pb-20 overflow-hidden bg-slate-50">
            ...
            <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-200/50 border border-slate-200 backdrop-blur-sm mb-8">
                    ...
                    <span className="text-xs font-semibold uppercase tracking-wider bg-gradient-to-r from-brand to-brand-dark bg-clip-text text-transparent">GBP Optimization Service</span>
                </div>
                ...
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tight text-slate-900 mb-6 max-w-5xl mx-auto leading-[1.1]">
                    Get Found First in <span className="bg-gradient-to-r from-brand to-brand-dark bg-clip-text text-transparent">Google Maps</span> for Your Clinic.
                </h1>

                <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-3xl mx-auto">
                    Healthcare Google Business Profile Optimization Service. Make your clinic unmissable on Google Maps and fill it with ready-to-book patients.
                </p>
                ...
                {/* Dashboard Mockup - Adapted for GBP */}
                <div className="relative max-w-5xl mx-auto">
                    <div className="bg-white rounded-2xl shadow-2xl border border-slate-100 p-2 md:p-4 rotate-x-12 transform-gpu perspective-1000">
                        ...
                        <div className="flex items-center justify-between border-b border-slate-100 pb-4 mb-6 px-4">
                            ...
                            <div className="text-xs font-medium text-slate-400 uppercase tracking-widest">Google Business Profile Performance</div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 p-4">
                            ...
                            <div className="flex flex-col items-center justify-center space-y-2">
                                <div className="text-sm text-slate-500">Map Views</div>
                                <div className="text-3xl font-bold text-slate-900">4,281</div>
                                <div className="flex items-center text-emerald-500 text-sm font-medium">
                                    <MapPin className="h-4 w-4 mr-1" /> +32%
                                </div>
                            </div>
                            {/* Stat 2 */}
                            <div className="flex flex-col items-center justify-center space-y-2">
                                <div className="text-sm text-slate-500">Website Visits</div>
                                <div className="text-3xl font-bold text-slate-900">892</div>
                                <div className="flex items-center text-emerald-500 text-sm font-medium">
                                    <Globe className="h-4 w-4 mr-1" /> +18%
                                </div>
                            </div>
                            {/* Stat 3 */}
                            <div className="flex flex-col items-center justify-center space-y-2">
                                ...
                                <div className="flex items-center text-emerald-500 text-sm font-medium">
                                    <Phone className="h-4 w-4 mr-1" /> +24%
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mt-8 flex items-end justify-between h-48 sm:h-64 gap-2 sm:gap-4 px-4 pb-4 border-b border-slate-100/50">
                            {[35, 55, 40, 70, 50, 85, 65, 45, 60, 80, 90, 95].map((height, i) => (
